"""
🎓 Бот-репетитор по всем предметам
Требования: pip install pyTelegramBotAPI anthropic

Запуск:
1. Установи библиотеки: pip install pyTelegramBotAPI anthropic
2. Запусти: python tutor_bot.py
"""
...
# ⚙️ НАСТРОЙКИ
# ============================================================
FREE_LIMIT = 10          # Бесплатных вопросов в день
PAID_PRICE = "299 руб"   # Цена подписки
ADMIN_ID = 908695451     # Твой Telegram ID
...
SUBJECT_PROMPTS = {
    ...
    "english": "You are an English tutor. Explain grammar rules in Russian, help with translations, correct mistakes and explain why. Use examples and exercises.",
...
def handle_message(message):
    ...
    try:
        ...
        system_prompt += "\n\nОтвечай на русском языке. Будь дружелюбным и понятным для школьника. Структурируй ответ, используй эмодзи для наглядности."
...
# ============================================================
# 🔧 ВЫДАТЬ ПРЕМИУМ (только для админа)
# ============================================================
